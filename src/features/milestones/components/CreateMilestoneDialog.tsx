    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="bg-white border-slate-200 sm:max-w-[420px] p-6">
          <DialogHeader>
            <DialogTitle className="text-base font-bold text-slate-900">Add Milestone</DialogTitle>
            <DialogDescription className="text-slate-500 text-xs">
              Create a key objective or checkpoint for this track.
            </DialogDescription>
          </DialogHeader>

          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 pt-2">
            <div className="space-y-1.5">
              <Label htmlFor="name" className="text-xs font-semibold text-slate-700">Milestone Name *</Label>
              <Input
                id="name"
                placeholder="e.g. Finish Module 1, Build Portfolio App"
